			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">URL Management System</h1>
						<div class="hero">
							...
							<img src="img/urlpic.jpg" class="pull-right display-image" alt="" style="width:210px">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="login.jsp" id="login-form" class="smart-form client-form">
								<header>
									Forgot Password
								</header>
								...
								<fieldset>
									...
									<section>
										...
										<div class="note">
											<a href="login.jsp">I remembered my password!</a>
										</div>
									</section>
